...
/**
 * UNB unauthorized error.
 * 
 * Handles when an invalid permission is encountered.
 */
class UnauthorizedError extends UnbError {
    /**
     * Throw a new `UnauthorizedError`.
     * 
    ...
    constructor(message, metaData = {}) {
        super(message, {
            code: metaData.code ?? UNB_ERROR_CODES.PERMISSION_ERROR,

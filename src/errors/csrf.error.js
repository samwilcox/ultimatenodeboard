 ...
 * UNB csrf error.
 * 
 * Handles when there are any CSRF security related errors.
 */
class CsrfError extends UnbError {
    /**
     * Throw a new `CsrfError`.
     * 
    ...
    constructor(message, metaData = {}) {
        super(message, {
            code: metaData.code ?? UNB_ERROR_CODES.CSRF_ERROR,

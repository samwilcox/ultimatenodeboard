...
UNB_ADMINCP.on('ui.init', () => {
    ...
    UNB_ADMINCP.editor.hyperlink = UNB_ADMINCP.editor.hyperlink || {
        editorKey: null,
        selection: null
    };
    ...
    $(document).on('click', '[data-unb-editor-insert-url-button]', function (e) {
        ...
        if (!editorKey) {
            UNB_ADMINCP.log.warn(`No editor found for link tool: ${editorKey}.`, 'UNBEditor');
            return;
        }
        ...
        UNB_ADMINCP.editor.hyperlink.editorKey = editorKey;

        UNB_ADMINCP.editor.hyperlink.selection = {
        ...
        if (!url) {
            UNB_ADMINCP.notify(locale.error.editor.hyperlinkUrlRequired, { error: true });
            return;
        }
        ...
        if (UNB_ADMINCP.editor.hyperlink.selection) {
            editor.commands.setTextSelection(UNB_ADMINCP.editor.hyperlink.selection);
        }
        ...
        UNB_ADMINCP.editor.hyperlink.editorKey = null;
        UNB_ADMINCP.editor.hyperlink.selection = null;
